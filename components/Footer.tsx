    ...
    <footer style={{ background: "var(--color-text)", color: "var(--color-bg)", marginTop: 64 }}>
      <div className="container" style={{ padding: "48px 24px", display: "grid", gap: 40, gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          ...
          <Link href="/como-elegimos/" style={{ color: "#A7CBF2", fontSize: 16 }}>Nuestros criterios →</Link>
        </div>
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          ...
          <Link href="/aviso-legal/" style={{ color: "#A7CBF2", fontSize: 16 }}>Aviso legal y privacidad</Link>
        </div>
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          <strong style={{ fontSize: 15, letterSpacing: 1 }}>WEB HERMANA</strong>
          <a href={PARTNER_ORBITOYS.url} style={{ color: "#A7CBF2", fontSize: 17, fontWeight: 800 }}>
            🪐 {PARTNER_ORBITOYS.nombre}
          </a>
      ...
      <div className="container" style={{ borderTop: "1px solid rgba(255,249,240,.2)", padding: "20px 24px", display: "flex", flexWrap: "wrap", gap: 20, fontSize: 16 }}>
        <Link href="/motricidad-fina/" style={{ color: "#A7CBF2" }}>Por habilidad</Link>
        <Link href="/por-etapa/" style={{ color: "#A7CBF2" }}>Por etapa</Link>
        <Link href="/regalos/" style={{ color: "#A7CBF2" }}>Regalos</Link>
        <Link href="/guias/" style={{ color: "#A7CBF2" }}>Guías</Link>
      </div>
    </footer>
  );
}
